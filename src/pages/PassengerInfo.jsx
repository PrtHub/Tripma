const PassengerInfo = () => {
  return (
    <>
      <div className="px-8 w-full flex lg:flex-row flex-col mt-20">
        <div className="w-full lg:w-[682px] flex flex-col items-start gap-10">
          ...
          <div className="flex flex-col items-start gap-2 w-full">
            ...
            <p className="text-[#7C8DB0] text-base font-normal">
            Each passenger is allowed one free carry-on bag and one personal item. First checked bag for each passenger is also free. Second bag check fees are waived for loyalty program members. See the <span className="text-[#605DEC]"> full bag policy.</span>
            </p>
          </div>
          <div className="w-full sm:w-[400px] flex items-start justify-between gap-10">
              <div className="flex flex-col items-start gap-2">
                  <p className="text-[#7C8DB0] text-base font-semibold">Passenger 1</p>
                  <p className="text-[#6E7491] text-base font-semibold">First Last</p>
              </div>
              <div className="flex flex-col items-center gap-2">
                  <p className="text-[#7C8DB0] text-base font-semibold">Checked bags</p>
                  <div className=" flex items-center gap-4">
                    <span className="text-[#605DEC] text-3xl font-semibold cursor-pointer">-</span>
                    <span className="text-[#6E7491] text-base font-semibold">1</span>
                    <span className="text-[#605DEC] text-xl font-semibold cursor-pointer ">+</span>
                  </div>
              </div>
          </div>
          <div className="flex items-center gap-5">
            <button className="py-2 px-4 border-[1px] border-[#605DEC] text-[#605DEC] rounded hover:bg-[#605DEC] hover:text-white transition-all duration-200">Save & close</button>
            <button className="py-2 px-4 border-[1px] border-[#7C8DB0] text-[#7C8DB0] bg-[#CBD4E6] rounded hover:bg-white transition-all duration-200">Select seats</button>
          </div>
        </div>
